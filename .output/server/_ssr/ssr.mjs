...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-7ibgqe5h.mjs");
...
var manifest = {
	"2a879a43978b93019c6481a9e5fc02c4cdf039704ec9b4d0831d41f4d9535b17": {
		functionName: "analyzeSession_createServerFn_handler",
		importer: () => import("./sessions-RvsMoGz1.mjs")
	},
	"3586a278f89f1147f8a2adb7e2e204d4dbaea7ca47f4b343eea566462ccb743b": {
		functionName: "rewriteMinutes_createServerFn_handler",
		importer: () => import("./sessions-RvsMoGz1.mjs")
	},
	"60dfd76f06d4b1e29345f77057730593a51e771ca193624152ff3c3d474a2452": {
		functionName: "generateCrossSummary_createServerFn_handler",
		importer: () => import("./sessions-RvsMoGz1.mjs")
	},
	"bb714c9ebbdcbeb29a5a04c991bccbe5f2b70c3f721c44e52acb038493f922e4": {
		functionName: "transcribeAudio_createServerFn_handler",
		importer: () => import("./stt-hJd6s5wU.mjs")
	},
	"cdaa15bed1b0afc647c05975c67e1490a5832ba05bf30114490a94aaec095b60": {
		functionName: "askProjectAssistant_createServerFn_handler",
		importer: () => import("./sessions-RvsMoGz1.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cwe42-hh.mjs").then((n) => n.t),
